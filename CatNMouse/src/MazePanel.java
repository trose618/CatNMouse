...
public class MazePanel extends JPanel {
	...
	public Color[][] color;  // holds the colors of all the squares, with null representing the background color (white).
	//public static ArrayList<int[]> visited = new ArrayList<int[]>();
